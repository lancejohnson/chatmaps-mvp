...
PARCELS_SCHEMA = {
    ...
    "columns": {
        ...
        "situs_street_name": {
            "type": "string",
            "description": "Street name only, without type suffix (e.g., 'PIONEER' for 'Pioneer Way')",
            "nullable": True,
            "good_for": ["search", "display", "address_queries", "area_analysis"],
            "bad_for": ["calculations"],
            "example": "PIONEER",
            "search_tips": "CRITICAL: Street names stored WITHOUT type suffix and in UPPERCASE. For 'Pioneer Way' search situs_street_name = 'PIONEER' AND situs_street_type = 'WY'",
        },
        "situs_street_type": {
            "type": "string",
            "description": "Street type abbreviation (ST, AVE, BLVD, WY, RD, etc.)",
            "nullable": True,
            "good_for": ["address_display", "address_search"],
            "example": "WY",
            "search_tips": "Required for exact address matching. Common mappings: Way=WY, Street=ST, Avenue=AVE, Road=RD, Drive=DR, Boulevard=BLVD",
        },
        ...
        "situs_city_name": {
            ...
            "search_tips": "CRITICAL: City names stored in UPPERCASE. For 'Mountain View' use situs_city_name = 'MOUNTAIN VIEW'",
        },
        "situs_state_code": {
            "type": "string",
        ...
        "situs_zip_code": {
            "type": "string",
            "description": "ZIP code of the property in ZIP+4 format",
            "nullable": True,
            "good_for": ["search", "geographic_filtering", "area_analysis"],
            "bad_for": ["calculations"],
            "example": "94041-1505",
            "search_tips": "CRITICAL: ZIP codes stored as ZIP+4 format. NEVER use = for exact matching. For ZIP '94041' use situs_zip_code LIKE '94041%' to match '94041-1505'",
        },
